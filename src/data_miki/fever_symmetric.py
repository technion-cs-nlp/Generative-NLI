# @mikimn: Modified multi_nli -> fever_symm
#
#
# coding=utf-8
...
class FeverSymmetric(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        downloaded_path = dl_manager.download(
            ...
            # "https://raw.githubusercontent.com/TalSchuster/FeverSymmetric/master/symmetric_v0.2/fever_symmetric_test.jsonl"
        )
        test_path = downloaded_path
        return [
        ...
        with open(filepath, 'rb') as f:
            for idx, line in enumerate(f):
                ...
                yield idx, {
                    ...
                    "evidence": json_obj["evidence_sentence"],
